...
By default the command prints a Markdown table for pull requests created
over the last seven days with:
...
default so unchanged PR entries are not fetched again.
