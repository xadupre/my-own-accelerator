...
per-PR comment totals, per-week comment totals, average PR duration per author
and week, and a **Job durations** sheet listing the duration of every successful
workflow job across all scanned PRs. A line-graph SVG is produced for each
